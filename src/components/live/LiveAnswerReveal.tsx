...
const REVEAL: Record<QuestionSetId, RevealEntry[]> = {
  A: [
    ...
    { answer: "K ■", logic: "The shapes repeat triangle, circle, square, and the letters climb A, C, E, G, I. Next comes K on a square." },
  ...
  C: [
    ...
    { answer: "Dina", image: "/questionscreenimages/setquestions/c8-children-hands-answer.png", logic: "Follow the chain of hands: Jenny to Sade to Miko to Dina. Dina is holding on at the end." },
  ...
  D: [
    ...
    { answer: "Unpredictable", logic: "The question tells you outright that its answer is unpredictable. The equation is a decoy with no bearing on it." },
    ...
    { answer: "MEDIA", logic: "The letters missing from A to Z are A, D, E, I and M. Rearranged they spell MEDIA." },
    { answer: "THEATRIC", image: "prompt", logic: "The eight letters T, H, E, A, T, R, I and C rearrange into one common word: THEATRIC." },
  ],
};
